...
def builtwith(url, headers=None, html=None, user_agent='builtwith', timeout=None):
        ...
        for app_name, app_spec in data['apps'].items():
            for key in 'html', 'script':
                ...
                for snippet in snippets:
                    ...
                    # TIME OUT
                    if timeout:  # ADDED
                        now_time = time.time()  # ADDED
                        if now_time - call_start > timeout:  # ADDED
                            return False  # ADDED
